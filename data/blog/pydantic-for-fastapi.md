...
draft: false
summary: Checkout the pydantic features with examples that makes your fastapi application better
---
...
### 1. [BaseSettings](https://pydantic-docs.helpmanual.io/usage/settings/) for reading environment variables
...
### 2. [Validators](https://pydantic-docs.helpmanual.io/usage/validators/) for custom data validation
...
### 3. [schema_extra](https://fastapi.tiangolo.com/tutorial/schema-extra-example/?h=sch#pydantic-schema_extra) for providing examples in docs
